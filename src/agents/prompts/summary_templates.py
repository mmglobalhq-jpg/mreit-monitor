...
2. **Securities Detail** — Produce a comprehensive portfolio breakdown with:
   ...
   Use the PRIOR PERIOD PORTFOLIO POSITIONS and PRIOR PERIOD MONTHLY METRICS data provided to calculate exact deltas. Match coupons across periods by their coupon field. Note "new position" for coupons that appear and "exited" for coupons that disappear.
